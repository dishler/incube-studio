        ...
        <section className="pt-[100px] sm:pt-[110px] md:pt-[120px] pb-12 md:pb-16">
          <Container>
            <nav className="text-neutral-500 text-[13px] mb-6 sm:mb-8">
              ...
              <span className="text-black">MVP Development</span>
            </nav>
            ...
            <p className="text-[16px] max-w-3xl leading-relaxed text-neutral-700">
              We help startups and product teams launch Minimum Viable Products (MVPs) quickly —
              with the right balance of speed, quality, and scalability. Our goal is simple: build just
              enough to validate your idea, attract users or investors, and set the foundation for
              future growth.
            </p>
          </Container>
        </section>
...
/* ===================== What We Build (MVP, FAQ-style) ===================== */
function WhatWeBuild() {
  const items = [
    { q: 'Startup MVPs', a: 'Lean, functional products that help you validate your idea fast.' },
    { q: 'SaaS Platforms', a: 'Testable SaaS applications with scalable architecture from day one.' },
    { q: 'Marketplace MVPs', a: 'Two-sided platforms that focus on core user journeys.' },
    { q: 'Mobile & Web Apps', a: 'Cross-platform apps built for web, iOS, and Android.' },
    { q: 'Internal Tools & Prototypes', a: 'Functional tools for operational needs or investor demos.' },
  ];
      ...
      <Container>
        <div className="grid md:grid-cols-2 items-start gap-10 lg:gap-24">
          ...
          <div className="shrink-0 flex justify-center md:justify-start">
            <Image
              src="/mvp-development/mvp-build.png"
...
function FixAndBetter() {
  const troubles = [
    'You’ve got a great idea — but don’t know where to start with development.',
    'You worry about wasting time or money building the wrong features.',
    'Hiring a full in-house dev team is expensive, slow, and risky at this stage.',
    'Your current dev process feels chaotic — unclear scope, missed deadlines, or technical debt.',
    'You need something functional and beautiful to pitch to investors or launch to early users — fast.',
  ];

  const solutions = [
    'We help you define the smallest set of features needed to launch — no fluff.',
    'Speed without sacrificing quality. Our proven process gets your MVP live in weeks, not months.',
    'Lean, scalable codebases — so you don’t need to rebuild later when you grow.',
    'Cross-functional team: product thinking, UX/UI design, and development — all aligned.',
    'Agile approach with fast iterations, transparent communication, and clear milestones.',
    'Post-launch support to iterate based on real user feedback.',
  ];
      ...
      <Container>
        <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="flex flex-col items-start">
            <div className="mb-2">
              <Image src="/mvp-development/arrow-icon.png" alt="Arrow Icon" width={135} height={140} />
            </div>
