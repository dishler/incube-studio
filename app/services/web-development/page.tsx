        ...
        <section className="pt-[100px] sm:pt-[110px] md:pt-[120px] pb-12 md:pb-16">
          <Container>
            ...
            <h1 className="text-[48px] sm:text-[64px] md:text-[80px] leading-none mb-6 md:mb-8">
              ...
              <span className="font-light italic">Development</span>
            </h1>

            {/* Description */}
            <p className="text-[16px] max-w-3xl leading-relaxed text-neutral-700">
              We develop custom websites that help businesses grow, connect with customers,
              and scale seamlessly. Whether it’s a marketing site, SaaS platform, or something
              completely custom – we bring your vision to life with clean design and powerful
              technology.
            </p>
          </Container>
        </section>
...
function FAQ() {
  const items = [
    { q: 'Custom Websites', a: 'High-performing websites designed from scratch to fit your brand and business goals.' },
    { q: 'Web Applications', a: 'Complex, interactive web apps with scalable backend solutions.' },
    { q: 'E-commerce Platforms', a: 'Conversion-focused online stores that are fast, secure, and easy to manage.' },
    { q: 'CMS-Driven Websites', a: 'Flexible content management using tools like Webflow, WordPress, or headless CMS.' },
    { q: 'API Integrations', a: 'We connect your product with third-party services, automate tasks, and streamline workflows.' },
  ];
      ...
      <Container>
        <div className="grid md:grid-cols-2 items-start gap-10 lg:gap-24">
          <div className="shrink-0 flex justify-center md:justify-start">
            <Image
              src="/web-development/web-dev.png"
          ...
          <div className="min-w-0">
            <h2 className="text-[40px] sm:text-[52px] md:text-[64px] leading-tight mb-8 md:mb-12">
              ...
              <span className="italic font-extralight">Do for your </span>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
          {works.map((work) => (
            <article key={work.title} className="flex flex-col bg-white rounded-lg h-full">
              {/* Клік по зображенню → перехід на кейс */}
              <button
                type="button"
...
/* ===================== Fix & Better (Web Development) ===================== */
function FixAndBetter() {
  const troubles = [
    'Your website feels slow, outdated, or clunky – users leave before engaging.',
    'Mobile experience is broken or inconsistent – most users bounce.',
    'Poor conversions – signups, purchases, or leads are way below expectations.',
    'Scaling is painful – adding features takes forever, bugs pile up.',
    'Managing content is hard – CMS is rigid and updates take too long.',
  ];

  const solutions = [
    'Fast, performant websites that load in seconds – anywhere, anytime.',
    'Pixel-perfect, responsive design – flawless on desktop, tablet, and mobile.',
    'Secure, scalable architecture – flexible foundations that grow with your business.',
    'Future-proof CMS and modular systems – easy to manage, update, and expand.',
    'Robust APIs and cloud infrastructure – so your product can scale without limits.',
  ];
      ...
      <Container>
        <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="flex flex-col items-start">
            <div className="mb-2">
              <Image src="/web-development/arrow-icon.png" alt="Arrow Icon" width={135} height={140} />
            </div>
